        ...
        <div className="col-md-4">
          <form className="row" onSubmit={this.handleBulkFileSubmit}>
            <div className="col-md-6">
              <input type="file" className="form-control-file  bg-success rounded" id='resumeFile' required onChange={this.handleBulkFile}/>
            </div>
            <div className="col-md-6">
              <button type="submit" class="btn btn-block btn-success">Add Bulk Company</button>
            </div>
          </form>
        </div>
      </div>
